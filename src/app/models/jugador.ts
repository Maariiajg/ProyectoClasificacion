export class Jugador {
  ...
  get anioNacimiento(): number { return this._anioNacimiento; }
  set anioNacimiento(value: number) { this._anioNacimiento = value; }


  // Getter calculado
  get edad(): number {
    return new Date().getFullYear() - this._anioNacimiento;
  }
}